  ...
  if (!user) {
    return (
      <div className="flex items-center gap-3">
        ...
        <a
          href="/join"
          className="inline-flex items-center justify-center font-bold min-h-[40px] rounded-lg px-5 text-sm transition-all hover:brightness-110 active:scale-[0.98] gap-2"
          style={{ background: 'linear-gradient(135deg, #CFB53B 0%, #E5D068 50%, #CFB53B 100%)', color: '#1a1402' }}
        >
      ...
      >
        {avatarUrl ? (
          ...
          <span
            ...
            style={{ backgroundColor: 'rgb(27, 23, 18)', color: '#CFB53B', border: '1px solid rgb(48, 42, 33)' }}
          >
            {initial}
          </span>
        )}
