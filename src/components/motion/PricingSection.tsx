...
export default function PricingSection() {
  return (
    <section
      ...
      style={{ background: 'var(--color-gray-950)', borderTop: '1px solid #1A1A1A' }}
    >
      <div className="max-w-lg mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-3 mt-4 mb-2">
            ...
            <span className="text-xl line-through" style={{ color: 'var(--color-gray-600)' }}>
              $97
            </span>
          </div>
          ...
          <div className="mt-6 pt-6" style={{ borderTop: '1px solid #2D2D2D' }}>
            ...
            <p className="text-xs mt-3" style={{ color: 'var(--color-gray-600)' }}>
              Instant access on the site after payment, plus confirmation by email.
            </p>
          </div>
        </motion.div>
      </div>
