...
export default defineConfig({
  ...
  redirects: {
    ...
    '/chat/edge': { status: 302, destination: 'https://t.me/MikkiMaseTeam_bot?start=ebook_ig_story_edge' },
    '/chat/wheel': { status: 302, destination: 'https://t.me/MikkiMaseTeam_bot?start=ebook_ig_story_wheel' },
    '/chat/felt': { status: 302, destination: 'https://t.me/MikkiMaseTeam_bot?start=ebook_ig_story_felt' },
    '/chat/side': { status: 302, destination: 'https://t.me/MikkiMaseTeam_bot?start=ebook_ig_story_side' },
    '/chat/field': { status: 302, destination: 'https://t.me/MikkiMaseTeam_bot?start=ebook_ig_story_field' },
    '/chat/seven': { status: 302, destination: 'https://t.me/MikkiMaseTeam_bot?start=ebook_ig_story_seven' },
    '/chat/basket': { status: 302, destination: 'https://t.me/MikkiMaseTeam_bot?start=ebook_ig_story_basket' },
    '/chat/joker': { status: 302, destination: 'https://t.me/MikkiMaseTeam_bot?start=ebook_ig_story_joker' },
